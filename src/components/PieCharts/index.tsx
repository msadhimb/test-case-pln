...
const chartData = [{ label: 'chrome', value: 9, fill: 'var(--color-chrome)' }];
...
export const ChartPie: React.FC<ChartData> = ({
  title,
  subTitle,
  desc,
  data,
  ...
  return (
    <Card className="flex flex-col bg-white relative">
      <div
        ...
        style={{
          backgroundImage: `url(/assets/pattern/circuitPattern.svg)`,
